...
namespace Persistence.Migrations
{
    ...
    [Migration("20251019112953_Add index to activity table")]
    partial class Addindextoactivitytable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.UserFollowing", b =>
                {
                    b.HasOne("Domain.UserApplication", "Observer")
                        .WithMany("Followings")
                        .HasForeignKey("ObserverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.UserApplication", "Target")
                        .WithMany("Followers")
